                    ...
                    <ul class="menu-inner py-1">
                        @if (Auth::user()->status != 'Deactive')
                            ...
                            @if (Auth::user()->role == 'Admin')
                                <!-- Layouts -->
                                <li class="menu-item {{ Route::is('list_user') ? 'active open' : '' }}">
                                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                                        <i class="menu-icon tf-icons bx bx-layout"></i>
                                        <div data-i18n="user_mangement">User Management</div>
                                    </a>

                                    <ul class="menu-sub">

                                        <li class="menu-item {{ Route::is('list_user') ? 'active' : '' }}">
                        ...
                        <!-- Profile -->
                        <li
                            class="menu-item {{ Route::is('profile.index', 'profile.create', 'profile.view') ? 'active open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons bx bx-user"></i>
                                <div data-i18n="user_mangement">Profile</div>
                            </a>
                            ...
                            <ul class="menu-sub">
                                @if (Auth::user()->role == 'Admin' || Auth::user()->role == 'Manager')
                                    <li class="menu-item {{ Route::is('profile.index') ? 'active' : '' }}">
                                        <a href="{{ route('profile.index') }}" class="menu-link">
                                            <div data-i18n="Without navbar">List Profile</div>
                                        </a>
                                    </li>
                                    <li class="menu-item {{ Route::is('profile.employee') ? 'active' : '' }}">
                                        <a href="{{ route('profile.employee') }}" class="menu-link">
                                            <div data-i18n="Without navbar">New Employee</div>
                                        </a>
                                    </li>
                                @endif
                                @if (Auth::user()->role == 'User' ||  Auth::user()->role == 'Employer' )
                                    ...
                                    <li class="menu-item {{ Route::is('profile.view') ? 'active' : '' }}">
                                        <a href="{{ route('profile.view', Auth::user()->id) }}" class="menu-link">
                        ...
                        @php
                            use App\Models\Profile; // Ensure to use the correct model

                            // Retrieve the first folder for the authenticated user
                        ...
                        @if (Auth::user()->role == 'Admin' || (Auth::user()->role == 'Employer' || Auth::user()->role == 'User' && $profile && $profile->status == 'active'))
                            ...
                            <li
                                class="menu-item {{ Route::is('job.index', 'job.apply', 'job.offer.creation', 'job.active', 'job.application', 'job.create', 'job.interview') ? 'active open' : '' }}">
                                <a href="javascript:void(0);" class="menu-link menu-toggle">
                                    <i class='menu-icon bx bx-globe'></i>
                                    <div data-i18n="user_mangement">Job</div>
                                </a>
                                ...
                                <ul class="menu-sub">
                                    ...
                                    @endif
                                    @if (Auth::user()->role == 'Admin')
                                        <li class="menu-item {{ Route::is('job.application') ? 'active' : '' }}">
                                            <a href="{{ route('job.application') }}" class="menu-link">
                                                <div data-i18n="Without navbar">Job application</div>
                                            </a>
                                        </li>
                                        <li class="menu-item {{ Route::is('job.active') ? 'active' : '' }}">
                                            <a href="{{ route('job.active') }}" class="menu-link">
                                                <div data-i18n="Without navbar">Job active</div>
                                            </a>
                                        </li>
                                    @endif
                                    <li class="menu-item {{ Route::is('job.interview') ? 'active' : '' }}">
                                        <a href="{{ route('job.interview') }}" class="menu-link">
                                            <div data-i18n="Without navbar">Interview Process</div>
                                        </a>
                                    </li>
                                    <li class="menu-item {{ Route::is('job.offer.creation') ? 'active' : '' }}">
                                        <a href="{{ route('job.offer.creation') }}" class="menu-link">
                                            <div data-i18n="Without navbar">Job Offer Creation</div>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul class="menu-sub">
                                    <li class="menu-item">
                                        <a href="{{route('visa.index')}}" class="menu-link">
                                            <div data-i18n="Error">Application Process</div>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="{{route('visa.apply')}}" class="menu-link">
                                            <div data-i18n="Error">Apply Visa</div>
                                        </a>
                                    </li>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('profile.view', Auth::user()->id) }}">
